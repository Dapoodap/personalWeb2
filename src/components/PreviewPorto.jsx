...
import gbr from "../assets/wrc.jpg";
import gbr1 from "../assets/palindrom.jpg";
  ...
  return (
    ...
    >
      <Container style={{ width: "100%" }}>
        ...
        <Row>
          <Col lg={12} style ={{textAlign:'center',maxWidth:'800px',margin:'auto',marginBottom:'10px'}}>
            <img src={gbr} style={{width:'100%'}} alt="" />
            <div className="text" style={{textAlign:'left'}}>
              <h4>WRC Landing Page</h4>
              <p>Tool : HTML,CSS</p>
            </div>
          </Col>
          <Col lg={12} style ={{textAlign:'center',maxWidth:'800px',margin:'auto',marginBottom:'10px'}}>
            ...
            <div className="text" style={{textAlign:'left'}}>
              <h4>Palindrom Generator</h4>
              <p>Tool : HTML,CSS, Vanilla Js</p>
            </div>
          </Col>
          <Col lg={12} style ={{textAlign:'center',maxWidth:'800px',margin:'auto',marginBottom:'10px'}}>
            <Button  style={{width:'100%',backgroundColor:'white',color:'black',border:'2px solid black'}}><Link className='navItem' style={{textDecoration:'none',color:'black'}} to={"/Porto"}>View All Project</Link></Button>
          </Col>
        </Row>
    </Container>
  );
