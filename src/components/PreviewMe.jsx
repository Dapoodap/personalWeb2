  ...
  return (
    ...
    >
      <Container style={{width:'100%'}}>
        ...
        >
          <Col xs={12} md={12} sm={12} style={{display:'flex',alignItems:'center'}}>
            <svg
        ...
        <p style={{fontSize : '18px',fontWeight :'400',textAlign:'justify',letterSpacing:'0',wordBreak:'break-all'}}>I'm Daffa Radhitya Pratama Wina Putra, I live in Semarang, Central Java, Indonesia since i was born. Right now i'm a student at Dian Nuswantoro University.  I study front-end development with React js. My goal is to make some apps (web based) and contribute to open source projects while study as computer science student...</p>
        <Button style={{fontSize :'20px',fontWeight:'500'}}><Link className='navItem' style={{textDecoration:'none',color:'white'}} to={"/About"}>See More</Link></Button></Col>
        </Row>
      </Container>
    </Container>
  );
